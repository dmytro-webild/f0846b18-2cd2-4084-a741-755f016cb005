...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        ...
        {
          text: "Call +1 778-317-7711",
          href: "tel:+17783177711",
        },
      ]}
      mediaItems={[
        {
        ...
        },
        {
          ...
          imageAlt: "Appliance service",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/young-loader-holding-red-heart-uniform-looking-joyful-front-view_176474-21370.jpg",
          imageAlt: "Technical detail",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/prosthetist-man-making-prosthetic-leg-while-working-laboratory_627829-7187.jpg",
          imageAlt: "Gas fitting",
        },
      ]}
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Expert Plumbing Systems",
          description: "Comprehensive diagnostics, repairs, and installations for all residential and commercial piping systems.",
          imageSrc: "http://img.b2bpic.net/free-photo/technician-checking-heating-system-boiler-room_169016-53973.jpg",
        },
        {
          title: "Certified Gas Solutions",
          description: "High-precision gas line fitting and appliance connections performed by Red Seal certified gas technicians.",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-worker-with-protective-mask-gloves_23-2148773449.jpg",
        },
        {
          title: "Preventative Maintenance",
          description: "Proactive identifying of potential system vulnerabilities before they escalate into costly and disruptive repairs.",
  ...
  <div id="trust" data-section="trust">
      ...
      metrics={[
        ...
        },
        {
          id: "3",
          value: "BC",
          title: "Reliability Across Province",
          items: [
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "1",
          title: "Are you Red Seal certified?",
          content: "Yes, we hold both Plumbing and Gas Fitting Red Seal certifications.",
        },
        {
          id: "2",
          title: "Do you offer emergency services?",
          content: "Yes, please call our emergency line at 778-317-7711.",
        },
        {
          id: "3",
          title: "What areas do you serve?",
          content: "We cover Metro Vancouver, Fraser Valley, Whistler/Squamish, and Vancouver Island.",
        },
      ]}
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "+1 778-317-7711",
              href: "tel:+17783177711",
            },
            {
              label: "Email Office",
              href: "mailto:info@simonplumbing.ca",
            },
          ],
        },
        {
